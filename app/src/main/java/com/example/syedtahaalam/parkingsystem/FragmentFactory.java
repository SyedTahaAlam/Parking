...
public class FragmentFactory {
    ...
    public static DateTimePickerFragment createDatePickerFragment(String date, String dateType, String choice, DateTimePickerFragment.ResultHandler resultHandler) {
    ...
    public static DateTimePickerFragment createDatePickerFragment(String date, String dateType, String choice) {
